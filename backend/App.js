...
const {Logindoc, changepassworddoctor, resetpassworddoctor, addSlots, Followup, rescheduleApp, getDrApp, addPres, viewDrPres} = require('./Controller/doctorController');
